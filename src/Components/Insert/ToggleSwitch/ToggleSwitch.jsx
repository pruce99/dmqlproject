...
export default function ToggleSwitch(props) {
  ...
  return (
    ...
    <div className='Toggle-container'>
        <div style={{marginLeft:"30px"}} onClick={handleACSwitch} className={`Switch-container ${acSwitchState}`}>
            Aircraft Code
        </div>
        <div onClick={handleSeatSwitch} className={`Switch-container ${seatSwitchState}`}>
            Seat
        </div>
    </div>
  )
